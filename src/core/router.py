...
class Router:
    ...
    def __init__(self, database, categorizer):
        ...
        # Button/list tap dispatcher (extracted from _route_button)
        from core.button_dispatcher import ButtonDispatcher
        self.button_dispatcher = ButtonDispatcher(self)
    ...
    def _route_button(self, phone_number: str, button_id: str, session: dict) -> list:
        """Route interactive button/list taps — delegates to ButtonDispatcher."""
        return self.button_dispatcher.dispatch(phone_number, button_id, session)
    ...
    def _show_recurring_services(self, phone_number: str) -> list:
        """Show recurring services — delegates to recurring handler."""
        if self.recurring:
