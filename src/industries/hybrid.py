...
class HybridIndustry(BaseIndustry):
            ...
            sections=[
                {
                    ...
                    "rows": [
                        ...
                        {"id": "menu_dashboard", "title": "📊 Dashboard & Reports",
                         "description": "Products + services, margins at a glance"},
                    ]
                },
                {
                    "title": "📂 Sections",
                    "rows": [
                        ...
                        {"id": "sec_inventory", "title": "📋 Catalog — Products & Supplies",
                         "description": "Your products, services, stock, prices, costs"},
    ...
    def handle_button(self, phone_number: str, button_id: str, session: dict) -> list:
        ...
        # to the dispatcher's _open_dashboard. WhatsApp keeps the hybrid dashboard.
            ...
            sections=[{
                ...
                "rows": [
                    {"id": "biz_dashboard", "title": "📊 Dashboard & Reports",
                     "description": "Products + services, margins, periods"},
